...
$(function(){
	...
	$('#kwickblock2').hover(function() {
		...
		$("#kwickblock1 .slideimage,#kwickblock3 .slideimage,#kwickblock4 .slideimage,#kwickblock5 .slideimage,#kwickblock6 .slideimage").stop().fadeTo("slow", 0.3);	// Fade the rest of the kwich panels
	},function(){
	...
	$('#kwickblock3').hover(function() {
		...
		$("#kwickblock1 .slideimage,#kwickblock2 .slideimage,#kwickblock4 .slideimage,#kwickblock5 .slideimage,#kwickblock6 .slideimage").stop().fadeTo("slow", 0.3);	// Fade the rest of the kwich panels
	},function(){
		$('.slidecaption').stop().fadeTo("slow", 0);
		$(".slide-minicaption").stop().fadeTo("slow", 0.8);
		$(".slideimage").stop().fadeTo("slow", 1);	
	...
	$('#kwickblock4').hover(function() {
		...
		$("#kwickblock1 .slideimage,#kwickblock2 .slideimage,#kwickblock3 .slideimage,#kwickblock5 .slideimage,#kwickblock6 .slideimage").stop().fadeTo("slow", 0.3);	// Fade the rest of the kwich panels").stop().fadeTo("slow", 0.3);
	},function(){
		$('.slidecaption').stop().fadeTo("slow", 0);
		$(".slide-minicaption").stop().fadeTo("slow", 0.8);
		$(".slideimage").stop().fadeTo("slow", 1);
